...
Gruvbox.palette = {
  ...
  bright_blue = "#83a598",
  bright_purple = "#c48084",
  bright_aqua = "#83b273",
  bright_orange = "#af5f00",
  neutral_red = "#cc241d",
...
local function get_groups()
  ...
  local groups = {
    ...
    CursorLineNr = { fg = colors.orange, bg = colors.bg1 },
    ...
    Character = { link = "GruvboxRed" },
    String = { fg = colors.red, italic = config.italic.strings },
    Boolean = { link = "GruvboxRed" },
    Number = { link = "GruvboxRed" },
    Float = { link = "GruvboxRed" },
    Type = { link = "GruvboxGreen" },
    StorageClass = { link = "GruvboxOrange" },
    Structure = { link = "GruvboxGreen" },
    Typedef = { link = "GruvboxGreen" },
    ...
    NavicIconsField = { link = "GruvboxOrange" },
    ...
    cOperator = { link = "GruvboxOrange" },
    cppOperator = { link = "GruvboxPurple" },
    cStructure = { link = "GruvboxGreen" },
    ...
    ["@keyword.return"] = { link = "GruvboxOrange" },
